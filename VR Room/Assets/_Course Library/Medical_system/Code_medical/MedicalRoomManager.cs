...
public class MedicalRoomManager : MonoBehaviour
{
    public List<MedicalSocketValidator> sockets;
    ...
    void HandleCorrect(MedicalSocketValidator s)
    {
        Recount();
    ...
    void HandleWrong(MedicalSocketValidator s)
    {
        OnWrongPlacement?.Invoke();
    }

    void HandleRemoved(MedicalSocketValidator s)
    {
        Recount();
    }
